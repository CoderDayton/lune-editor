...
fn all_palette_commands() -> Vec<PaletteCommand> {
    let mut cmds = vec![
        ...
        palette_cmd("AI: Ask About Selection", AppCommand::AiAskSelection),
        palette_cmd("AI: Refactor File", AppCommand::AiRefactorFile),
        palette_cmd("AI: Summarize Changes", AppCommand::AiSummarizeChanges),
        palette_cmd("Toggle Markdown Preview", AppCommand::ToggleMarkdownPreview),
